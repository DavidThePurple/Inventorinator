# Detailed release test reference

Use the [v0.1.1 checklist](release-checklist.md) for release sign-off. This is the detailed test reference; select relevant cases for the candidate. Check an item only after performing the steps
