...
download_migrations() {
  ...
  migration_names='001_workshop_state.sql 002_anonymous_workspaces.sql 003_device_roles.sql 004_owner_devices.sql 005_team_roles_audit.sql 006_shared_build_permissions.sql 007_builder_quantity_integrity.sql 008_owner_recovery.sql 009_owner_durability.sql 010_owner_resilience.sql 011_device_role_management.sql 012_incremental_entity_sync.sql 013_preserve_legacy_locations.sql 014_authenticated_entity_read_policy.sql 015_disable_legacy_snapshot_writes.sql 016_remote_offline_purge_policy.sql 017_stable_device_repair.sql'
