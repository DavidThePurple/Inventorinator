...
begin
 perform public.set_inventorinator_mouser_credentials('22000000-0000-0000-0000-000000000001','fixture-secret');
 value := public.get_inventorinator_mouser_credentials('22000000-0000-0000-0000-000000000001');
 if value->>'api_key' <> 'fixture-secret' then raise exception 'Round trip failed'; end if;
 if public.get_inventorinator_mouser_credentials('22000000-0000-0000-0000-000000000002') is not null then raise exception 'Workspace isolation failed'; end if;
 begin
  perform * from public.inventorinator_mouser_credentials;
 ...
 '00000000-0000-0000-0000-000000000106',''] loop
  ...
  begin
   perform public.get_inventorinator_mouser_credentials('22000000-0000-0000-0000-000000000001');
  ...
  begin
   perform public.set_inventorinator_mouser_credentials('22000000-0000-0000-0000-000000000001',null);
 ...
 begin
  perform public.set_inventorinator_mouser_credentials('22000000-0000-0000-0000-000000000001','');
  raise exception 'Invalid credentials accepted';
 exception when others then if sqlerrm not like '%Invalid Mouser%' then raise; end if; end;
 perform public.set_inventorinator_mouser_credentials('22000000-0000-0000-0000-000000000001',null);
 if public.get_inventorinator_mouser_credentials('22000000-0000-0000-0000-000000000001') is not null then raise exception 'Clear failed'; end if;
end;
$$;
rollback;
